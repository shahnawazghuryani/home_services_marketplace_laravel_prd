...
class MarketplaceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $categories = collect([
            ...
            ['name' => 'Pest Control', 'icon' => 'Bug', 'description' => 'Termite, cockroach, mosquito, and rodent treatment services.'],
            ['name' => 'Painting', 'icon' => 'Paintbrush', 'description' => 'Interior/exterior paint, polish, and wall touch-up services.'],
            ['name' => 'Carpentry', 'icon' => 'Hammer', 'description' => 'Woodwork, doors, cabinets, furniture repair, and custom fittings.'],
            ['name' => 'Masonry', 'icon' => 'BrickWall', 'description' => 'Block work, plaster, boundary walls, and civil repair jobs.'],
            ['name' => 'Tiling', 'icon' => 'Grid', 'description' => 'Floor and wall tile installation, repair, and re-grouting.'],
            ['name' => 'Waterproofing', 'icon' => 'Droplets', 'description' => 'Roof, bathroom, and basement waterproofing with leakage treatment.'],
            ['name' => 'False Ceiling', 'icon' => 'LayoutPanelTop', 'description' => 'Gypsum and POP false ceiling design and installation.'],
            ['name' => 'Glass & Aluminum', 'icon' => 'PanelTop', 'description' => 'Windows, doors, shower enclosures, and aluminum partitions.'],
            ['name' => 'Steel & Welding', 'icon' => 'Wrench', 'description' => 'Gate, grill, railing, and custom steel fabrication services.'],
            ['name' => 'CCTV & Security Systems', 'icon' => 'Shield', 'description' => 'CCTV camera installation and security system setup.'],
            ['name' => 'Solar Installation', 'icon' => 'Sun', 'description' => 'Solar panel installation, maintenance, and troubleshooting.'],
            ['name' => 'UPS & Inverter Services', 'icon' => 'Battery', 'description' => 'UPS/inverter installation, battery replacement, and repair.'],
            ['name' => 'Generator Services', 'icon' => 'Cog', 'description' => 'Generator installation, tune-up, and maintenance services.'],
            ['name' => 'Appliance Repair', 'icon' => 'Settings', 'description' => 'Home appliance diagnosis and repair by trained technicians.'],
            ['name' => 'Refrigerator Repair', 'icon' => 'Refrigerator', 'description' => 'Cooling issues, gas charging, and fridge repair support.'],
            ['name' => 'Washing Machine Repair', 'icon' => 'Shirt', 'description' => 'Automatic and semi-automatic washing machine services.'],
            ['name' => 'Geyser & Water Heater', 'icon' => 'Flame', 'description' => 'Gas/electric geyser repair, installation, and maintenance.'],
            ['name' => 'RO Water Filter Services', 'icon' => 'Filter', 'description' => 'RO plant installation, filter replacement, and servicing.'],
            ['name' => 'Internet & Networking', 'icon' => 'Wifi', 'description' => 'Router setup, LAN wiring, and Wi-Fi optimization services.'],
            ['name' => 'Handyman', 'icon' => 'Tool', 'description' => 'Small fixes like fixtures, shelves, and minor home repairs.'],
            ['name' => 'Movers & Packers', 'icon' => 'Truck', 'description' => 'Local and intercity shifting with packing and loading support.'],
            ['name' => 'Gardening & Landscaping', 'icon' => 'Leaf', 'description' => 'Lawn maintenance, plant care, and landscape setup.'],
            ['name' => 'Sofa & Carpet Cleaning', 'icon' => 'Sofa', 'description' => 'Deep sofa, mattress, and carpet shampoo cleaning.'],
            ['name' => 'Curtains & Blinds', 'icon' => 'Blinds', 'description' => 'Curtain stitching, blind fitting, and maintenance services.'],
            ['name' => 'Home Renovation', 'icon' => 'Building2', 'description' => 'Complete home renovation and remodeling services.'],
            ['name' => 'Interior Design', 'icon' => 'Ruler', 'description' => 'Interior planning, design consultation, and execution support.'],
